...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('https://unicons.iconscout.com/release/v3.0.6/css/line.css') }}" />
...
<body>
    ...
    <div class="modal fade" id="modal__mobile__adicionar" data-backdrop="static" data-keyboard="false" tabindex="-1"
                ...
                <div class="modal-body">
                    <div class="modal__plus">
                        <ul>
                            ...
                            <li>
                                <a href="#" data-toggle="modal" data-target="#tipo__postagem__feed">Publicitar no
                                    Feed</a>
                            </li>
                            <li>
                                <a href="#" data-toggle="modal" data-target="#modal__tipo__empresa">Criar
                                    Empresa</a>
                            </li>
                            @auth
                                <li>
                                                ...
                                                @foreach (Auth::user()->mobileCompanies() as $company)
                                                    <li>
                                                        @if ($company->status == 'active')
                                                            <a href="{{ route('companies.profile', $company->companyName) }}"
                                                                class="actives"
                                                                data-active="{{ $company->id }}">{{ $company->companyName }}
                                                            </a>
                                                        @else
                                                            <a href="#" style="font-size: 15px;color:grey;"
                                                                class="inactives" data-inactive="{{ $company->id }}">
    ...
    <!-- MODAL TIPO POSTAGEM -->
    <div class="modal fade" id="tipo__postagem__feed" data-backdrop="static" data-keyboard="false" tabindex="-1"
        aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="botaoApresentadoTipoEmpresas">
                        ...
                        <button data-toggle="modal" data-target="#modal__postagem__perfil">
                            <img src="" alt="" />
    ...
    @auth
        <main class="main__section "
            data-interest="{{ Auth::user()->interestUser() == null ? 0 : Auth::user()->interestUser() }}">
        @endauth
        @guest
            <main class="main__section ">
            @endguest
                ...
                @auth
                    @if (Auth::user()->company->count() != 0)
                        <a href="{{ route('companies.index') }}" class="logo">
                            <img src="{{ asset('assets/img/logo/logo_dourado.png') }}" alt=""
                                class="img-fluid " />
                        </a>
                    @else
                        <a href="{{ route('guest.indxe') }}" class="logo">
            ...
            <div class="menu-mobile">
                ...
                <ul>
                    @Auth
                        <li>
                            <a href="#">Meu Saldo
                                <strong>{{ number_format(Auth::user()->money, 2, ',', '.') }}kz</strong></a>
                        </li>
                    @endauth
                    @guest()
                        <li>
            ...
            <div class="container">
                <nav>
                    <ul>
                        ...
                        <li>
                            <a href="#" data-toggle="modal" data-target="#modal__mobile__adicionar">
        ...
        <!-- MODAL PESQUISAR -->
        <div class="modal fade" id="pesquisa" data-backdrop="static" data-keyboard="false" tabindex="-1"
            aria-labelledby="staticBackdropLabel" aria-hidden="true">
